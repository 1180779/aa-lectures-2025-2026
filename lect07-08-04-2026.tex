...
Takie kody nazywa się \underline{kodami prefixowymi} (chociaż powinno być bezprefixowe).
...
\begin{figure}[ht]
	...
	\begin{minipage}{0.48\textwidth}
		...
		\begin{tikzpicture}[mytree, every node/.append style={font=\scriptsize}]
			\node {58}
			child { node {33}
					child { node {18}
							child { node {8}
...
Kod prefixowy reprezentowany przez drzewo $T$ nazywamy \underline{optymalnym}, jeśli $B(T)$ jest najmniejsze możliwe. \\
Drzewo ukorzenione nazywamy \underline{binarnym}, jeśli każdy wierzchołek ma co najwyżej dwoje dzieci. \\
Drzewo binarne nazywamy \underline{regularnym}, jeśli każdy wierzchołek wewnętrzny ma dokładnie dwoje dzieci.
	...
	\begin{enumerate}
		\item Łączymy $n$ i $s$: \\
		      \begin{tikzpicture}[htree]
			      ...
			      child { node {s,3} };
		      \end{tikzpicture}
		      \quad Zostają: $(t, 4), (a, 10), (i, 12), (r, 13), (e, 15)$.
		...
		\item Łączymy $4$ i $t$: \\
		      \begin{tikzpicture}[htree]
			      ...
			      child { node {t,4} };
		      \end{tikzpicture}
		      \quad Zostają: $(a, 10), (i, 12), (r, 13), (e, 15)$.
		...
		\item Łączymy $25$ i $33$ (Ostateczne drzewo kodów): \\
		      \begin{tikzpicture}[htree]
			      \node {58}
			      child { node {25}
