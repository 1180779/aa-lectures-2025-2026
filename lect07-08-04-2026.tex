...
Takie kody nazywa się \textbf{kodami prefixowymi} (chociaż powinno być bezprefixowe).
...
Kod prefixowy reprezentowany przez drzewo $T$ nazywamy \textbf{optymalnym}, jeśli $B(T)$ jest najmniejsze możliwe. \\
Drzewo ukorzenione nazywamy \textbf{binarnym}, jeśli każdy wierzchołek ma co najwyżej dwoje dzieci. \\
