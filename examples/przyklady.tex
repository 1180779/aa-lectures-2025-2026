...
% Same DANE wejściowe (po dwie instancje na algorytm) --- bez rozwiązań,
...
\begin{center}
	...
	{\small\itshape Po dwie instancje na algorytm --- same dane wejściowe, do samodzielnego prześledzenia.}
\end{center}
\bigskip
...
\begin{example}[Szeregowanie zadań -- instancja 2]
	Zadania (nie są jeszcze posortowane); wyznaczyć harmonogram minimalizujący sumę kar:
	\begin{aztable}
		\centering
		\renewcommand{\arraystretch}{1.2}
		\begin{NiceTabular}{c|ccccccc}[margin,hvlines]
...
\begin{example}[Approx Subset Sum -- instancja 1]
	$S = \{104,\ 102,\ 201,\ 101\}$ (w~kolejności $x_1,\dots,x_4$), \quad $t = 308$, \quad $\varepsilon = 0{,}4$.\\
...
\input{rozwiazania/01-najblizsze-punkty-1}
\input{rozwiazania/02-matrix-chain-1}
