...
Pełny przykład działania schematu wraz z~dowodem poprawności i~analizą złożoności przedstawimy w~podrozdziale~\ref{subsec:subsetsum-cd} (następny wykład). Najpierw -- nieco na~marginesie -- pokazujemy NP-zupełność problemu sumy podzbiorów.
