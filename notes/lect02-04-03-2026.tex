...
\begin{flalign*}
	 & n^a = \BO(n^b) \text{ gdy } 0 < a \leq b  &  & \log n = \BO(n^\epsilon) \text{ gdy } \epsilon > 0 &   &  & \\
	 & a^n = \BO(b^n) \text{ gdy } 1 < a \leq b  &  & \log_a n = \BT(\log_b n) \text{ gdy } a, b > 1     &   &  & \\
	 & n^a = \BO(b^n) \text{ gdy } 0 < a,\ b > 1 &  &                                                    &
\end{flalign*}
...
\begin{lemma}
	...
	\begin{flalign*}
		T(n) = \begin{cases}
			       \BT(1)                                  & \text{gdy } n = 1              \\[1ex]
			       a\cdot T\left(\frac{n}{b}\right) + f(n) & \text{gdy } n = b^i,\ i \geq 1
		       \end{cases} &  &  &  &
	\end{flalign*}

	to
	\begin{flalign*}
		T(n) = \BT\left(n^{\log_b a}\right) + \sum_{j = 0}^{\log_b n - 1} a^j f\left(\frac{n}{b^j}\right) &  &  &  &
	\end{flalign*}
\end{lemma}

\begin{proof}
	\begin{flalign} \label{eq:utor:star}
		a^{\log_b n} = \left(b^{\log_b a}\right)^{\log_b n} = b^{\log_b a \cdot \log_b n} = b^{\log_b n \cdot \log_b a} = \left(b^{\log_b n}\right)^{\log_b a} = n^{\log_b a} &  &  &  &
	\end{flalign}
	...
	\begin{flalign*}
		...
		= \cdots + n^{\log_b a} T(1)
		= \BT\left(n^{\log_b a}\right) + \sum_{j = 0}^{\log_b n - 1} a^j f\left(\frac{n}{b^j}\right)                     &                                                                                                                                                            &  &  & \tag*{\qedhere}
	\end{flalign*}
\end{proof}
...
\begin{proof}
	...
	\begin{enumerate}
		\item Gdy $f(n) = \BO\left(n^{\log_b a - \epsilon}\right)$. Wtedy
		      \begin{flalign*}
			      ...
			      = \BO\left(\underbracket{\sum_{j = 0}^{\log_b n - 1} a^j \left(\frac{n}{b^j}\right)^{\log_b a - \epsilon}}_{\blacktriangle}\right) &                                                                                                                                    &  &  &     \\[1.5ex]
			                                                                                                                                         & \blacktriangle
			      = \sum_{j = 0}^{\log_b n - 1} a^j \frac{n^{\log_b a - \epsilon}}{b^{j(\log_b a - \epsilon)}}
			      ...
			      = \BO\left(n^{\log_b a}\right)                                                                                                     &                                                                                                                                    &  &  &     \\[1.5ex]
			                                                                                                                                         & \text{Z lematu: } T(n)
			      = \sum_{j = 0}^{\log_b n - 1} a^j f\left(\frac{n}{b^j}\right) + \BT\left(n^{\log_b a}\right)
			      = \BO\left(n^{\log_b a}\right) + \BT\left(n^{\log_b a}\right)
			      = \BT\left(n^{\log_b a}\right)                                                                                                     &                                                                                                                                    &  &  &
		      \end{flalign*}

		\item Gdy $f(n) = \BT\left(n^{\log_b a}\right)$. Wtedy:
		      \begin{flalign*}
			      ...
			      = \BT\left(n^{\log_b a} \log_b n\right)                                                                       &                                                                                        &  &  &     \\[1.5ex]
			                                                                                                                    & \text{Z lematu: } T(n)
			      = \sum_{j = 0}^{\log_b n - 1} a^j f\left(\frac{n}{b^j}\right) + \BT\left(n^{\log_b a}\right)                  &                                                                                        &  &  &     \\[1.5ex]
			                                                                                                                    & = \BO\left(n^{\log_b a}\log n\right) + \BT\left(n^{\log_b a}\right)
			      = \BT\left(n^{\log_b a}\log n\right)                                                                          &                                                                                        &  &  &
		      \end{flalign*}

		\item Gdy $f(n) = \BM\left(n^{\log_b a + \epsilon}\right)$ oraz $a \cdot f\left(\frac{n}{b}\right) \leq c\cdot f(n)$ dla jakiegoś $c < 1$ i odpowiednio dużych $n$.

		      Z założenia $f\left(\frac{n}{b}\right) \leq \frac{c}{a}f(n)$, więc drogą iteracji:
		      \begin{flalign*}
			                                                         & f\left(\frac{n}{b^j}\right) \overset{(\star)}{\leq} \left(\frac{c}{a}\right)^j f(n) = \frac{c^j}{a^j}f(n)                                                                                                 &  &  &                 & \\[1.5ex]
			                                                         & (\star) \,\, f\left(\frac{n}{b^j}\right) \leq \frac{c}{a} f\left(\frac{n}{b^{j-1}}\right) \leq \left(\frac{c}{a}\right)^2 f\left(\frac{n}{b^{j-2}}\right) \leq \dots \leq \left(\frac{c}{a}\right)^j f(n) &  &  &                 & \\[1.5ex]
			                                                         & \sum_{j = 0}^{\log_b n - 1} a^j f\left(\frac{n}{b^j}\right)
			      ...
			      = \BM(f(n))                                        &                                                                                                                                                                                                           &  &  &                   \\[1.5ex]
			                                                         & \text{Z lematu: } T(n)
			      = \sum_{j = 0}^{\log_b n - 1} a^j f\left(\frac{n}{b^j}\right) + \BT(n^{\log_b a})
			      = \BT(f(n)) + \BT(n^{\log_b a}) = \BT(f(n))        &                                                                                                                                                                                                           &  &  & \tag*{\qedhere}
		      \end{flalign*}
	\end{enumerate}
\end{proof}
...
\begin{conclusion}
	...
	\begin{flalign*}
		T(n) = \begin{cases}
			       \BT(n^{\log_b a}) & \text{gdy } f(n) = \BO(n^{\log_b a - \epsilon}) \implies k < \log_b a \iff b^k < a \\[1ex]
			       \BT(n^k \log n)   & \text{gdy } f(n) = \BT(n^{\log_b a}) \implies k = \log_b a \iff b^k = a            \\[1ex]
			       \BT(n^k)          & \text{gdy } f(n) = \BM(n^{\log_b a + \epsilon}) \implies k > \log_b a \iff b^k > a
		       \end{cases} &  &  &  &
	\end{flalign*}
\end{conclusion}
