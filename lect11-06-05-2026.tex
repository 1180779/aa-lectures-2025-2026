...
\begin{example}{Pokrycie zbioru}
	\begin{figure}[H]
		...
		\begin{tikzpicture}[scale=0.95]
			...
			\coordinate (e1) at (-2.4, 2);
			\coordinate (e2) at (0, 2);
			\coordinate (e3) at (2.4, 2);
			\coordinate (e4) at (-2.4, 0);
			\coordinate (e5) at (0, 0);
			\coordinate (e6) at (2.4, 0);
			\coordinate (e7) at (-2.4, -2);
			\coordinate (e8) at (0, -2);
			\coordinate (e9) at (2.4, -2);
			
			% Elipsy zbiorów
			\draw (0, -1)    ellipse (3.2  and 1.7);   % S_1
			\draw (0, 2)     ellipse (3.2  and 0.65);  % S_2
			\draw (-0.22, 1) ellipse (0.55 and 1.55);  % S_3
			\draw (0.22, 1)  ellipse (0.55 and 1.55);  % S_6
			\draw (-1.2, 0)  ellipse (1.5  and 0.55);  % S_4
			\draw (2.4, 1)   ellipse (0.55 and 1.55);  % S_5
			
			% Etykiety zbiorów
			\node[anchor=north] at (0, -2.85)   {$S_1$};
			\node[anchor=east]  at (-3.35, 2)   {$S_2$};
			\node[anchor=south] at (-0.45, 2.7) {$S_3$};
			\node[anchor=south] at (0.5, 2.7)   {$S_6$};
			\node[anchor=east]  at (-3.35, 0)   {$S_4$};
			\node[anchor=south] at (2.7, 2.7)   {$S_5$};
