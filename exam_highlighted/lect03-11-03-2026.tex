	      ...
	      \begin{itemize}
		      \item[\uemph{Dziel:}] Dzielimy punkty $P$ pionową prostą $l$ na dwa podzbiory $P_L$ i $P_R$ na lewo i na prawo
		            ...
		            \begin{center}
			            ...
			            \end{tikzpicture}
			            \captionof{figure}{Podział zbioru $P$ pionową prostą $l$ na podzbiory $P_L$
...
\begin{proof}[Dowód poprawności]
	...
	\begin{center}
		...
		\end{tikzpicture}
		\captionof{figure}{Prostokąt $2\delta\times\delta$ ograniczony prostymi $y = y_p$ oraz
	...
	\begin{center}
		...
		\end{tikzpicture}
		\captionof{figure}{W kwadracie $\delta\times\delta$ nie zmieści się $5$ punktów parami
