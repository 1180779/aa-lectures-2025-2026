...
Zajęcia $z_i$ i $z_j$ nazywamy \textbf{zgodnymi}, jeśli $\langle s_i, t_i) \cap \langle s_j, t_j) = \emptyset$.
...
\subparagraph{Własność optymalnej podstruktury:}
...
\subparagraph{Analiza poprawności:}
