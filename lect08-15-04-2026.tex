...
\begin{proof}
	...
	\begin{flalign*}
		...
		&= f(a) \cdot d_T(a) + f(x) \cdot d_T(x) - f(a) \cdot d_{T'}(a) - f(x) \cdot d_{T'}(x) = && \\
		&= f(a) \cdot d_T(a) + f(x) \cdot d_T(x) - f(a) \cdot d_T(x) - f(x) \cdot d_T(a) =  && \\ 
		&= f(a) (d_T(a) - d_T(x)) - f(x) (d_T(a) - d_T(x)) = && \\
