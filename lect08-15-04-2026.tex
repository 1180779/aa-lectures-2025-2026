...
\begin{flalign*}
  \vphantom{\sum_{j=1}^n \left( \frac{n}{3} - \left\lfloor \frac{j-1}{3} \right\rfloor \right)} & t_{i_1} + t_{i_2} + t_{i_3} + (t_{i_1} + t_{i_4}) + (t_{i_2} + t_{i_5}) + (t_{i_3} + t_{i_6}) + (t_{i_1} + t_{i_4} + t_{i_7}) + (t_{i_2} + t_{i_5} + t_{i_8}) + (t_{i_3} + t_{i_6} + t_{i_9}) +                                 &  & \\
	 \vphantom{\sum_{j=1}^n \left( \frac{n}{3} - \left\lfloor \frac{j-1}{3} \right\rfloor \right)} & + \dots + (t_{i_1} + t_{i_4} + \dots + t_{i_{n-2}}) + (t_{i_2} + t_{i_5} + \dots + t_{i_{n-1}}) + (t_{i_3} + t_{i_6} + \dots + t_{i_n}) =                                                                                       &  & \\
...
\begin{proof}
	...
	\begin{flalign*}
		f(\Pi) - f(\Pi') & = \sum_{j=1}^n A_j \cdot t_{i_j} - \sum_{j=1}^n A_j \cdot t_{i'_j} = A_k \cdot t_{i_k} + A_l \cdot t_{i_l} - A_k \cdot t_{i'_k} - A_l \cdot t_{i'_l} = &  & \\
                     & = \vphantom{\sum_{j=1}^n} A_k \cdot t_{i_k} + A_l \cdot t_{i_l} - A_k \cdot t_{i_l} - A_l \cdot t_{i_k} = A_k(t_{i_k} - t_{i_l}) - A_l(t_{i_k} - t_{i_l}) =                    &  & \\
