...
\begin{itemize}[nosep]
	...
	\item $f: \bigcup_{I \in D_\Pi} S(I) \to \R$ -- funkcja celu. Zakładamy $f(s) > 0$ dla każdego rozwiązania
	      dopuszczalnego (potrzebne, by iloraz jakości miał sens; dla typowych problemów koszt jest z~natury dodatni).
\end{itemize}
